...
informative:
  ...
  CLOUDFLARE-MT:
    ...
    org: Cloudflare
    date: 2026
    target: https://developers.cloudflare.com/reference-architecture/architectures/magic-transit/#default-configuration-ingress-only-direct-server-return
...
...
* Content Delivery Networks (CDNs) using Direct Server Return (DSR)
  (see [I-D.ietf-savnet-inter-domain-problem-statement] and
  [I-D.ietf-sidrops-bar-sav]): An ingress AS originates a BGP route
  ...
  attract user requests.
* DDoS mitigation with Direct Server Return (DSR)
  [CLOUDFLARE-MT]: The scrubber AS
